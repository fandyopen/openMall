module.exports = {
    currentPage: null,
    currentPageOptions: {},
  navbarPages: ["pages/index/index", "pages/cat/cat", "pages/cart/cart", "pages/user/user", "pages/list/list", "pages/search/search", "pages/topic-list/topic-list", "pages/video/video-list", "pages/miaosha/miaosha", "pages/shop/shop", "pages/pt/index/index", "pages/book/index/index", "pages/share/index", "pages/quick-purchase/index/index", "mch/m/myshop/myshop", "mch/shop-list/shop-list", "pages/integral-mall/index/index", "pages/integral-mall/register/index", "pages/article-detail/article-detail", "pages/article-list/article-list", "pages/order/order", "active/community/community"],
    onLoad: function(t, e) {
        this.currentPage = t, this.currentPageOptions = e;
        var o = this;
        this.checkSSK();/// // 检查session是否过期
       // this.setParentId(e), this.getNavigationBarColor(),//非商城不用
        if (this.setUserInfo(), this.setWxappImg(), this.setStore(),  this.setDeviceInfo(), this.setPageClasses(), this.setPageNavbar(),
